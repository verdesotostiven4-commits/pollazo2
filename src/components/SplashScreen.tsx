...
export default function SplashScreen({ onDone }: Props) {
  ...
  return (
    <div
      className="fixed inset-0 flex flex-col items-center justify-center z-[200] hero-water"
      style={{
    ...
    >
      ...
      {/* Logo — drops from top with elastic bounce, transparent bg */}
      <div
        style={{
      ...
      >
        <img
          ...
          style={{ filter: 'drop-shadow(0 16px 48px rgba(0,0,0,0.3)) drop-shadow(0 0 20px rgba(251,146,60,0.4))' }}
        />
      </div>
